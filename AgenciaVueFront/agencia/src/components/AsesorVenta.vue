    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar flat color="white">
                <v-toolbar-title>Asesores de venta</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
...
<script>
    ...
    export default {
        ...
        methods:{
            listar(){
                let me=this;
                axios.get('api/AsesorVentas/Listar').then(function(response){
                    //console.log(response);
                    me.asesores=response.data;
            ...
            guardar () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    //Código para guardar
                    let me=this;
                    axios.put('api/AsesorVentas/Actualizar',{
                        'IdAsesorVenta':me.id,                                 
                        'Nombres':me.nombres,
                    ...
                    //Código para guardar
                    let me=this;
                    axios.post('api/AsesorVentas/Crear',{
                        'Nombres':me.nombres,
                        'Apellidos': me.apellidos,
                        'NumDocumento':me.numDocumento 
                    }).then(function(response){
